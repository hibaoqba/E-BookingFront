            ...
            <tbody>
              {reservations.map(reservation => (
                <tr key={reservation.id}>
                  ...
                  <td>
                    <button
                      className='btn btn-danger delete-reservation-button'
                      onClick={() => DeleteReservation(reservation.id, fetchCarReservations)}
                    >
              ...
              {apartmentReservations.map(reservation => (
                <tr key={reservation.id}>
                  ...
                  <td>
                    <button
                      className='btn btn-danger delete-reservation-button'
                      onClick={() => DeleteReservation(reservation.id, fetchApartmentReservations)}
                    >
                      <FontAwesomeIcon icon={faTrash} />
                    </button>
                  </td>
