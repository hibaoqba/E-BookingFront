  ...
  const handleConfirmReservation = async () => {
    try {
      ...
      if (paymentMethod === 'online') {
        navigate(`/car/payment`, { state: { reservationData, car } });
      }
       else if (paymentMethod === 'onSite') {
        response = await axios.post('http://localhost:8080/api/reservations', {
          user: { id: userInfo.id },
          car: { id: car.id },
          ...
          <div className="profile-right-section">
            <div className="column">
              ...
              <div className="profile-field">
                ...
                <input type="tel" name="phone" defaultValue={userData.phoneNumber} onChange={(e) => setUserData({ ...userData, phoneNumber: e.target.value })} />
              ...
              <div className="profile-field">
                ...
                <input type="date" name="birthday" defaultValue={userData.birthDate} onChange={(e) => setUserData({ ...userData, birthDate: e.target.value })} />
